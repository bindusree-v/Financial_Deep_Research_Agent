"""
Energy Agent module for the Financial Research Agent.
This agent is responsible for handling queries specific to the Energy sector.
"""
...
class EnergyAgent:
    ...
    def __init__(self):
        """
        Initializes the EnergyAgent by setting up its dependencies.
        ...
        print("Energy Sector Agent initialized")
    ...
    def run(self, query: str) -> str:
        ...
        Args:
            query (str): The user's query about the energy sector.
            
        Returns:
            str: The generated markdown report containing the research findings.
        """
        # Notify that the deep research process is beginning
        print("Energy Agent starting deep research...")
        
        # Run the research loop for the query and specify the "Energy" sector
        findings = self.research_loop.run(query, "Energy")
        
        # Generate a final markdown report using the gathered findings
        report = self.report_generator.generate(findings, "Energy", query)
