"""
Insurance Agent module for the Financial Research Agent.
This agent is responsible for handling queries specific to the Insurance sector.
"""
...
class InsuranceAgent:
    ...
    specifically for the Insurance sector.
    """
    
    def __init__(self):
        """
        Initializes the InsuranceAgent by setting up its dependencies.
        ...
        print("Insurance Sector Agent initialized")
    ...
    def run(self, query: str) -> str:
        ...
        Args:
            query (str): The user's query about the Insurance sector.
            
        Returns:
            str: The generated markdown report containing the research findings.
        """
        # Notify that the deep research process is beginning
        print("Insurance Agent starting deep research...")
        
        # Run the research loop for the query and specify the "Insurance" sector
        findings = self.research_loop.run(query, "Insurance")
        
        # Generate a final markdown report using the gathered findings
        report = self.report_generator.generate(findings, "Insurance", query)
